...
class AuthService {
  final String _baseUrl = 'http://10.192.80.83:9000/base/api/v1/base/security/usuario/validar/datos';
  final String _permissionsUrl = 'http://10.192.80.83:9000/base/api/v1/base/security/usuario/validar/permisos';
